...
const jobsMockJson = [
  {
    ...
    status: 'in progress', duration: 4.7, result_filename: 'job-file.txt', size: '10 KB'
  },
  {
    id: 2, name: 2, created: '1.10.2025', owner: 'test@email.com',
    status: 'failed', duration: 2.5, result_filename: 'job-file.txt', size: '10 KB'
  },
  {
    id: 3, name: 3, created: '1.10.2025', owner: 'test@email.com',
    status: 'success', duration: 2.3, result_filename: 'job-file.txt', size: '10 KB'
  },
  {
    id: 4, name: 4, created: '1.10.2025', owner: 'test@email.com',
    status: 'waiting', duration: 1.9, result_filename: 'job-file.txt', size: '10 KB'
  },
];
/* eslint-enable */

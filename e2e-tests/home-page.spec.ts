...
test.describe('Create job tests', () => {
  ...
  test('should create job with pipeline and input file', async({ page }) => {
    ...
    await page.getByLabel('minimal').click();
  ...
  test('should check if start button is disabled when no pipeline is selected', async({ page }) => {
    await page.locator('#add-job-button').click();
    await page.locator('input[id="file-upload"]').setInputFiles('./fixtures/input-file-1.vcf');
  ...
  test('should check if start button is disabled when no file is uploaded', async({ page }) => {
    await page.locator('#add-job-button').click();
    await page.getByLabel('minimal').click();
  ...
  test('should check if start button is disabled when no yml is written', async({ page }) => {
    await page.locator('#add-job-button').click();
    await page.locator('input[id="file-upload"]').setInputFiles('./fixtures/input-file-1.vcf');
    await page.getByText('YML text editor').click();
  ...
  test('should check if start button is disabled when uploaded file is removed', async({ page }) => {
    await page.locator('#add-job-button').click();
    await page.getByLabel('minimal').click();
    await page.locator('input[id="file-upload"]').setInputFiles('./fixtures/input-file-1.vcf');
    await expect(page.locator('#start-button')).toBeEnabled();
  ...
  test('should check if start button is disabled when invalid file is uploaded', async({ page }) => {
    await page.locator('#add-job-button').click();
    await page.getByLabel('minimal').click();
